...
const ProductCard: React.FC<ProductCard> = ({
  ...
  const onPreview: MouseEventHandler<HTMLButtonElement> = (event) => {
    ...
    return(
        <div onClick={handleClick} className="bg-white group cursor-pointer rounded-xl border p-3 space-y-4">          <div className="aspect-square rounded-xl bg-gray-100 relative">
             <Image
